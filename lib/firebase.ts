...
// ✅ Firebase config from your Firebase Console (corrected bucket URL)
const firebaseConfig = {
  ...
  storageBucket: 'atlas-lumigram-d7ebe.appspot.com', // ✅ correct domain
...
// ✅ Optional: Only initialize analytics if supported (not required in Expo Go)
